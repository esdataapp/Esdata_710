"""DEPRECADO
Este módulo pertenece a la primera versión del sistema de orquestación.
Se mantiene solo con fines de referencia histórica. No usar en producción.
La nueva implementación vive en `orchestrator.py`.
"""
